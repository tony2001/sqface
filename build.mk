...
config_h_in = src/sqface_config.h.in
...
clean:
	@rm -rf m4 src/*.lo src/*.la src/*.o src/*.a src/.libs src/.deps examples/.deps examples/Makefile examples/Makefile.in src/Makefile 
	rm -rf src/Makefile.in src/stamp-h1 src/sqface_config.h*
